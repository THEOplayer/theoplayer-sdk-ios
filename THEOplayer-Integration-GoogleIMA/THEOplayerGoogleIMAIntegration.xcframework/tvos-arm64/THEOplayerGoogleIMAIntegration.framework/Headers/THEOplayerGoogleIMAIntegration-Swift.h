...
#ifndef THEOPLAYERGOOGLEIMAINTEGRATION_SWIFT_H
#define THEOPLAYERGOOGLEIMAINTEGRATION_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="THEOplayerGoogleIMAIntegration",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS_NAMED("GoogleIMAIntegrationFactory")
@interface THEOplayerGoogleIMAIntegrationFactory : NSObject
/// Creates and returns a new <code>GoogleImaIntegration</code>.
/// remark:
...
SWIFT_PROTOCOL_NAMED("GoogleImaIntegration_Objc")
@protocol THEOplayerGoogleImaIntegration <THEOplayerAds, THEOplayerIntegration>
...
///
- (void)requestAdsWithSrc:(NSString * _Nonnull)src renderingSettings:(IMAAdsRenderingSettings * _Nullable)renderingSettings;
...
SWIFT_PROTOCOL_NAMED("NativeGoogleImaAd_Objc")
